...
export RECIPIES_DIR=/home/mib3
export BOB_DEV=${RECIPIES_DIR}/dev
LD_LIBRARY_PATH=$BOB_DEV/build/system/ext-boost-dev/1/workspace/install/lib64:$LD_LIBRARY_PATH
export LD_LIBRARY_PATH
export GOPATH=$HOME/tools/gopath
export GOROOT=$HOME/tools/go1.10.3
export GOBIN=$GOROOT/bin
export GO15VENDOREXPERIMENT=1
export PATH=$PATH:$HOME/bin:/usr/local/bin:$GOBIN:$GOPATH/bin
